  ...
  const tips = [
    ...
    'Colour by chain gives chain A the same colour in every model and panel, and the export legend names each chain. Click a chain\'s swatch in Models → Composition, or in Publish → Edit figure labels, to give it any colour you like — sessions and share links keep it.',
