  ...
  const tips = [
    ...
    'Annotate → Compare this position: pick the mutated residue, press the button, and every shown model gets its side chain drawn and its own residue named — Ala15 against Gly15 — with the difference stated in one line. After Align visible the same press adds the neighbourhood table: how far the site and every residue within the cutoff moved, with Highlight neighbourhood and an effect CSV. Make site figure then builds the whole figure in one press: an overview panel with the site marked and a close-up with the reference solid and the others faded, ticked and lettered in the figure builder ready to download.',
